package cxw.cn.svplayer.common;
...
public class LogUtils {
     ...
     */
    public static String TAG = "svplayer_sdk";
    /**
     ...
     * The log dir path
     */
    protected static String logDirPath = Environment.getExternalStorageDirectory() + "/svplayer_sdk";
    /**
